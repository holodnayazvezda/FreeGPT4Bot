...
from utils.chatgpt.chat_gpt_users_worker import get_history_of_requests, add_request_to_history
from utils.chatgpt.chat_gpt_worker import ask_chat_gpt_and_return_answer
from utils.chatgpt.gigachat.gigachat_image_worker import get_images_from_gigachats_answer
from utils.chatgpt.gigachat.tokens_calculator import calculate_prompt_tokens

from langchain.chat_models.gigachat import GigaChat

from utils.chatgpt.requests_counter import increase_the_number_of_requests_for_the_user
...
async def ask_gigachat(prompt: str, user_id: int) -> tuple:
    ...
    try:
        ...
        Thread(target=async_functions_process_starter,
               args=(increase_the_number_of_requests_for_the_user, ["./data/databases/quantity_of_requests.sqlite3",
