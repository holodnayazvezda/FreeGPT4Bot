...
from bot_utils.chatgpt.chat_gpt_users_worker import clear_history_of_requests
from bot_utils.chatgpt.requests_counter import get_amount_of_requests_for_user, get_available_amount_of_requests_to_chat_gpt
from bot_utils.database.folder_worker import create_or_dump_user
...
async def clear_chat_gpt_conversation(message, bot_instance: BotInfo):
    Thread(target=async_functions_process_starter, args=(clear_history_of_requests,
                                                         ['./bot_data/databases/history_of_requests_to_chatgpt.sqlite3',
